...
const {
  ...
  const ownerNumber = ['923196891871']
...
const sessdata = config.SESSION_ID.replace("Binuka-MD~", '');
...
const port = process.env.PORT || 3000;
  ...
  if (connection === 'close') {
    ...
    let up = `*✨ Hello, KAMRAN-MD Legend! ✨*

╭─〔 *🤖 KAMRAN-MD BOT* 〕  
├─▸ *Simplicity. Speed. Power!*  
╰─➤ *Your New WhatsApp Sidekick is Here!*

*❤️ Thank you for Choosing KAMRAN-MD!*

╭──〔 🔗 *Quick Links* 〕  
├─ 📢 *Join Our Channel:*  
│   Click [**Here**](https://whatsapp.com/channel/0029VbAhxYY90x2vgwhXJV3O) to join!  
├─ ⭐ *Give Us a Star:*  
│   Star Us [**Here**](https://github.com/DRKAMRAN-MD/KAMRAN-MD)!  
╰─🛠️ *Prefix:* \`${prefix}\`

> _© MADE BY DR KAMRAN_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/m1jjwx.jpg` }, caption: up });
  }
});
    ...
    try {
        ...
        if (!activatedUsers.has(from)) {
            if (lowerText === "chatbot on") {
                ...
                await conn.sendMessage(from, { text: "Chatbot Activated! Ab Aap Mujhse Baat Kar Saktay Hain Thanks For Using KAMRAN-MD.", quoted: m });
            } else {
